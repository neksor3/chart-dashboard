...
def render_scanner_table(metrics, selected_symbol):
    ...
    html = f"""<table style='border-collapse:collapse;font-family:{FONTS};font-size:11px;width:100%;line-height:1.3'>
        <thead><tr>
...
def create_4_chart_grid(symbol, chart_type='line'):
    ...
    fig.update_layout(template='plotly_dark', height=650, margin=dict(l=50,r=90,t=60,b=60),
...
def render_legend():
    zc = zone_colors()
    st.markdown(f"""
        <div style='padding:5px 12px;background-color:#16213e;border-radius:3px;font-family:{FONTS};font-size:11px;letter-spacing:0.02em'>
            <span style='color:#e2e8f0;font-weight:600'>Levels</span>&nbsp;
            <span style='color:#6b7280'>■</span> <span style='color:#e2e8f0'>Prev</span>&nbsp;&nbsp;
            <span style='color:{zc["above_high"]}'>■</span> <span style='color:#e2e8f0'>Hi</span>&nbsp;&nbsp;
            <span style='color:{zc["below_low"]}'>■</span> <span style='color:#e2e8f0'>Lo</span>&nbsp;&nbsp;
            <span style='color:#fbbf24'>■</span> <span style='color:#e2e8f0'>50%</span>&nbsp;&nbsp;&nbsp;
            <span style='color:#e2e8f0;font-weight:600'>Retrace</span>&nbsp;
            <span style='color:#be185d'>■</span> <span style='color:#e2e8f0'>Buy</span>&nbsp;&nbsp;
            <span style='color:#0284c7'>■</span> <span style='color:#e2e8f0'>Sell</span>&nbsp;&nbsp;&nbsp;
            <span style='color:#e2e8f0;font-weight:600'>MA</span>&nbsp;
            <span style='color:#ffffff'>■</span> <span style='color:#e2e8f0'>20</span>&nbsp;&nbsp;
            <span style='color:#a855f7'>■</span> <span style='color:#e2e8f0'>40</span>&nbsp;&nbsp;&nbsp;
            <span style='color:#e2e8f0;font-weight:600'>Price</span>&nbsp;
            <span style='color:{zc["above_high"]};border:1px solid #ffffff80;padding:0 2px;border-radius:2px;font-weight:700'>▲</span> <span style='color:#e2e8f0'>Hi</span>&nbsp;&nbsp;
            <span style='color:{zc["above_mid"]}'>■</span> <span style='color:#e2e8f0'>↑Mid</span>&nbsp;&nbsp;
            <span style='color:{zc["below_mid"]}'>■</span> <span style='color:#e2e8f0'>↓Mid</span>&nbsp;&nbsp;
            <span style='color:{zc["below_low"]};border:1px solid #ffffff80;padding:0 2px;border-radius:2px;font-weight:700'>▼</span> <span style='color:#e2e8f0'>Lo</span>&nbsp;&nbsp;&nbsp;
            <span style='color:#e2e8f0;font-weight:600'>RSI</span>&nbsp;
            <span style='color:{zc["above_mid"]}'>■</span> <span style='color:#e2e8f0'>&gt;50</span>&nbsp;&nbsp;
            <span style='color:{zc["below_low"]}'>■</span> <span style='color:#e2e8f0'>&lt;50</span>&nbsp;&nbsp;&nbsp;
            <span style='color:#e2e8f0;font-weight:600'>Signal</span>&nbsp;
            <span style='color:#facc15;border:1px solid #ffffff80;padding:0 2px;border-radius:0;font-weight:700'>■</span> <span style='color:#e2e8f0'>Reversal</span>
...
def main():
    ...
    with col_chart_area:
        with st.spinner('Loading charts...'):
            try:
                fig, levels = create_4_chart_grid(st.session_state.symbol, st.session_state.chart_type)
