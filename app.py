...
<style>
    ...
    .sanpo-logo { font-family: 'Outfit', sans-serif !important; font-size: 24px !important; font-weight: 600 !important; letter-spacing: 0.12em; color: #f8fafc; line-height: 1; }
    ...
    st.markdown(f"""
        ...
        <div style='display:flex;align-items:center;justify-content:space-between;padding:10px 16px;margin-bottom:6px'>
            <div style='display:flex;align-items:center;gap:12px'>
                ...
                <span style="font-family:'Outfit',sans-serif !important;font-size:24px;font-weight:600;letter-spacing:0.12em;color:#f8fafc;line-height:1">SANPO</span>
            </div>
