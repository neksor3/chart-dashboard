...
<style>
    ...
    .stApp { background-color: #1e1e1e; font-family: 'M PLUS 1', sans-serif; }
    header[data-testid="stHeader"] { background-color: #1e1e1e; }
    [data-testid="stSidebar"] { background-color: #16213e; }
    .stSelectbox > div > div { background-color: #16213e; color: #b0b0b0; font-family: 'M PLUS 1', sans-serif; }
    .stTextInput > div > div > input { font-family: 'M PLUS 1', sans-serif; }
    ...
    button[kind="secondary"] { background-color: #16213e; color: white; border: 1px solid #2a4a6a; font-family: 'M PLUS 1', sans-serif; }
    .stButton > button { font-size: 11px !important; padding: 4px 8px !important; min-height: 30px !important; font-family: 'M PLUS 1', sans-serif !important; }
    ...
    st.markdown(f"""
        ...
        <div style='display:flex;align-items:center;justify-content:space-between;padding:10px 16px;margin-bottom:6px'>
            <div style='display:flex;align-items:center;gap:12px'>
                ...
                <span style='font-family:Chakra Petch,sans-serif;font-size:24px;font-weight:700;letter-spacing:0.08em;color:#f8fafc;line-height:1'>SANPO</span>
            </div>
